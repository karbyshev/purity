...
Definition axiom2 := forall A B C t f g, @bind B C (@bind A B t f) g = bind t (fun x => bind (f x) g).
End Axioms.
...
- rewrite /Monad.axiom0; intuition; by apply: extensionality.
- rewrite /Monad.axiom1; intuition.
  apply: extensionality => s. by case: (t s).
